...
int main()
{
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        lightingShader.setFloat("light.outerCutOff", glm::cos(glm::radians(35.0f)));
        ...
        if(color == 1){
        lightingShader.setVec3("light.diffuse", 0.9f, 0.0f, 0.0f);
        lightingShader.setVec3("light.specular", 1.0f, 0.0f, 0.0f);
        }

        if(color == 2){
        lightingShader.setVec3("light.diffuse", 0.0f, 0.9f, 0.0f);
        lightingShader.setVec3("light.specular", 0.0f, 1.0f, 0.0f);
        }

        if(color == 3){
        lightingShader.setVec3("light.diffuse", 0.0f, 0.0f, 0.9f);
        lightingShader.setVec3("light.specular", 0.0f, 0.0f, 1.0f);
        }
